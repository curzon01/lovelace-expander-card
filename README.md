...
If you like this repo please give it a ⭐️, fork it and contribute or donate it:

[![release][release-badge]][release-url]
![downloads][downloads-badge]
![build][build-badge]
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=curzon01_lovelace-expander-card&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=curzon01_lovelace-expander-card)
...
First a few words to start with. A big thank you goes to @Alia5 (https://github.com/Alia5/lovelace-expander-card), who initially launched the card. Also thanks to @MelleD (https://github.com/MelleD/lovelace-expander-card), who continued the project.

I forked this card for my own HomeAssistant to make the built-in editor of expander card available again, even if it's buggy - it works better for me than starting yaml from scratch every time I add an epxander card. I give no guarantee for the functionality and no promise of lifelong maintenance, as I do the whole thing in my free time. Of course, I am happy about every contribution and PR.
...
3. Add this repository (https://github.com/curzon01/lovelace-expander-card) via HACS Custom repositories ([How to add Custom Repositories](https://hacs.xyz/docs/faq/custom_repositories/))

[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=curzon01&repository=lovelace-expander-card&category=plugin)
...
[release-badge]: https://img.shields.io/github/v/release/curzon01/lovelace-expander-card?style=flat-square
[downloads-badge]: https://img.shields.io/github/downloads/curzon01/lovelace-expander-card/total?style=flat-square
[build-badge]: https://img.shields.io/github/actions/workflow/status/curzon01/lovelace-expander-card/build.yml?branch=main&style=flat-square
...
[hacs]: https://hacs.xyz
[release-url]: https://github.com/curzon01/lovelace-expander-card/releases
[paypal-me-url]: https://www.paypal.me/NorbertRichterDE
